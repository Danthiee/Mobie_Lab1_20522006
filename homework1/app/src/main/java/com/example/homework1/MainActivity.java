...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = "Nguyễn Đình Đan Thy";
        String email = "danthy8053@gmail.com";
        String introduction = "I like playing video games and listening music";
        String subject = "I learn at UIT-VNUHCM from 2020.";
        String learning = "Web application development, Mobile development, Data Anlysis, Bussiness Analysis";
